    ...
    <div class="modal fade" id="detail<?php echo $sqrow['salesid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
				...
				<?php
					$sales=mysqli_query($conn,"select * from sales left join tblcustomers on tblcustomers.id=sales.id where salesid='".$sqrow['salesid']."'");
					$row=mysqli_fetch_array($sales);
				?>
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<span>Customer: <strong><?php echo ucfirst($row1[2])." ".ucfirst($row1[3])."!" ?></strong></span>
						...
						<div class="col-lg-12">
							<table width="100%" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php
										$total=0;
										$pd=mysqli_query($conn,"select * from sales_detail left join tblproduct on tblproduct.productid=sales_detail.productid where salesid='".$sqrow['salesid']."'");
										while($pdrow=mysqli_fetch_array($pd)){
											...
											<tr>
												...
												<td align="right">
													<?php 
														$subtotal=$pdrow['price']*$pdrow['sales_qty'];
